...
public class UserCredentialServiceQueryConstants {
	...
	public static final String GET_USERCREDENTIAL_BY_USERID_QUERY = "select id,username,password,productitemid,status,createdby,createddate,modifiedby,modifieddate from usercredential where id=?";
	public static final String GET_DELETE_USER_CREDENTIAL_QUERY = "UPDATE usercredential SET  modifiedby=?, modifieddate=?, password=?, status=? WHERE id=?";
