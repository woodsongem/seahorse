...
public class QueryConstants {
	...
	public static final String GETINCOMETYPEBYUSERIDQUERY = "SELECT userid, status, id, category, createdby, createddate, description, modifiedby, modifieddate, name FROM coldfish_dev.incometype where userid={0} and status=''ACTIVE''";
	public static final String GETINCOMETYPEQUERY = "SELECT userid, status, id, category, createdby, createddate, description, modifiedby, modifieddate, name  FROM coldfish_dev.incometype where category=''{0}''";
