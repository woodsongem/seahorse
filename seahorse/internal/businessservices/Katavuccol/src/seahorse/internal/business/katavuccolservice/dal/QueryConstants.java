...
public class QueryConstants {	
	...
	public static final String GET_UPDATE_CREDENTIAL_QUERY = "UPDATE credential SET value=?, credentialtypeid=?, modifiedby=?, modifieddate=?,description=? where id=? and userid=? ";
