...
public class QueryConstants {	
	...
	public static final String GET_CREDENTIAL_TYPE_DETAILS_BY_ID_QUERY = "SELECT userid, id, createdby, createddate, description, isduplicationallowed, issubitemallowed, modifiedby, modifieddate, name, status FROM credentialtype where id=? and userid=? ";
