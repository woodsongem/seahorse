...
public class CredentialTypeServiceRepositoryMapper implements ICredentialTypeServiceRepositoryMapper {
	...
	public CredentialTypeModel mapCredentialTypeModel(Row typeDAOResult) {
		...
		credentialTypeModel.setCreatedBy(KatavuccolServiceUtility.ToString(typeDAOResult.getUUID(DataBaseColumn.CREATEDBY)));
		...
		credentialTypeModel.setId(KatavuccolServiceUtility.ToString(typeDAOResult.getUUID(DataBaseColumn.ID)));
		credentialTypeModel.setModifiedBy(KatavuccolServiceUtility.ToString(typeDAOResult.getUUID(DataBaseColumn.MODIFIEDBY)));
		...
		credentialTypeModel.setUserId(KatavuccolServiceUtility.ToString(typeDAOResult.getUUID(DataBaseColumn.USERID)));
